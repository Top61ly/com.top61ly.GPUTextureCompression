// https://github.com/microsoft/Xbox-ATG-Samples/blob/main/XDKSamples/Graphics/FastBlockCompress/

float oneOverTextureWidth;
...
void LoadTexelsRGBABias(Texture2D tex, SamplerState samp, float oneOverTextureSize, uint2 threadIDWithinDispatch, uint mipBias, out float3 blockRGB[16], out float blockA[16])
{
    ...
    float4 rgba;
    float2 location = float2(threadIDWithinDispatch * 4) * oneOverTextureSize;
    rgba = tex.SampleLevel(samp, location, mipBias, int2(0, 0));
    blockRGB[0] = rgba.rgb;
    blockA[0] = rgba.a;
    rgba = tex.SampleLevel(samp, location, mipBias, int2(1, 0));
    blockRGB[1] = rgba.rgb;
    blockA[1] = rgba.a;
    rgba = tex.SampleLevel(samp, location, mipBias, int2(2, 0));
    blockRGB[2] = rgba.rgb;
    blockA[2] = rgba.a;
    rgba = tex.SampleLevel(samp, location, mipBias, int2(3, 0));
    blockRGB[3] = rgba.rgb;
    blockA[3] = rgba.a;
    rgba = tex.SampleLevel(samp, location, mipBias, int2(0, 1));
    blockRGB[4] = rgba.rgb;
    blockA[4] = rgba.a;
    rgba = tex.SampleLevel(samp, location, mipBias, int2(1, 1));
    blockRGB[5] = rgba.rgb;
    blockA[5] = rgba.a;
    rgba = tex.SampleLevel(samp, location, mipBias, int2(2, 1));
    blockRGB[6] = rgba.rgb;
    blockA[6] = rgba.a;
    rgba = tex.SampleLevel(samp, location, mipBias, int2(3, 1));
    blockRGB[7] = rgba.rgb;
    blockA[7] = rgba.a;
    rgba = tex.SampleLevel(samp, location, mipBias, int2(0, 2));
    blockRGB[8] = rgba.rgb;
    blockA[8] = rgba.a;
    rgba = tex.SampleLevel(samp, location, mipBias, int2(1, 2));
    blockRGB[9] = rgba.rgb;
    blockA[9] = rgba.a;
    rgba = tex.SampleLevel(samp, location, mipBias, int2(2, 2));
    blockRGB[10] = rgba.rgb;
    blockA[10] = rgba.a;
    rgba = tex.SampleLevel(samp, location, mipBias, int2(3, 2));
    blockRGB[11] = rgba.rgb;
    blockA[11] = rgba.a;
    rgba = tex.SampleLevel(samp, location, mipBias, int2(0, 3));
    blockRGB[12] = rgba.rgb;
    blockA[12] = rgba.a;
    rgba = tex.SampleLevel(samp, location, mipBias, int2(1, 3));
    blockRGB[13] = rgba.rgb;
    blockA[13] = rgba.a;
    rgba = tex.SampleLevel(samp, location, mipBias, int2(2, 3));
    blockRGB[14] = rgba.rgb;
    blockA[14] = rgba.a;
    rgba = tex.SampleLevel(samp, location, mipBias, int2(3, 3));
    blockRGB[15] = rgba.rgb;
    blockA[15] = rgba.a;
}
...
//--------------------------------------------------------------------------------------
uint4 CompressBC1Block(float3 block[16], float colorScale = 1.0f)
{
    ...
    return uint4(maxColor565, minColor565, indices & 0xffff, indices >> 16);
}
